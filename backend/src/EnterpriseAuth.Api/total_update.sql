...
ALTER TABLE [Staging] ADD [ZREC_0] nvarchar(1) NOT NULL DEFAULT N'';
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260420054528_AddRecordTypeToStaging', N'8.0.0');
GO
...
ALTER TABLE [Staging] ADD [ZITMDES_0] nvarchar(255) NULL;
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260420064614_AddItemDescriptionToStaging', N'8.0.0');
GO
