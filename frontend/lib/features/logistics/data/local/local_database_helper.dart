  ...
  Future<List<Map<String, dynamic>>> getReconciledDetails(
    ...
    return await db.rawQuery(
      ...
      SELECT 
        ...
        (COALESCE(det.$colDetEaScanned, 0) + COALESCE(SUM(CASE WHEN scn.$columnItemStatus IN ('A', 'DELETED_ORIGINAL', 'REVERSED') AND (scn.$columnExcludeFromEod IS NULL OR scn.$columnExcludeFromEod = 0) THEN scn.$columnEaQuantity ELSE 0 END), 0)) as reconciledEaQuantity,
