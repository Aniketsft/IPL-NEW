...
class SyncStatusHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<UnsyncedDataCubit, bool>(
      builder: (context, hasUnsyncedData) {
        final orange = hasUnsyncedData ? Colors.redAccent : theme.primaryColor;
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            hasUnsyncedData ? 'Pending Sync' : 'Offline Mode',
                            style: TextStyle(
                              color: hasUnsyncedData ? Colors.redAccent : (isDark ? Colors.white : Colors.black87),
                              fontSize: 14,
